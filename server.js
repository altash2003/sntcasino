...
io.use((socket, next)=>session({secret:SESSION_SECRET,resave:false,saveUninitialized:false,cookie:{httpOnly:true,sameSite:"lax"}})(socket.request, socket.request.res || {}, next));
